...
class RetrofitSimilarMoviesDataSource @Inject constructor(
    ...
    override suspend fun getSimilarMovies(id: Int, page: Int): RequestNetworkResponse<SimilarMovieNetworkResponse> {
...
interface SimilarMoviesDataSource {
    suspend fun getSimilarMovies(id: Int, page: Int) : RequestNetworkResponse<SimilarMovieNetworkResponse>
}