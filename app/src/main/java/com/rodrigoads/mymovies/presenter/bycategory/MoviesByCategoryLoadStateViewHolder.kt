...
class MoviesByCategoryLoadStateViewHolder(
    ...
    private val progressBar = moviesByCategoryLoadMoreStateLargeLayoutBinding.progressBarLargeLoadStateLoading
    private val textViewError = moviesByCategoryLoadMoreStateLargeLayoutBinding.textViewLargeLoadStateError.also {
